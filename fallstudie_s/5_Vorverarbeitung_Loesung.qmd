# KW 43: Lösung Datenvorverarbeitung


```{r}
#| include: false

knitr::opts_chunk$set(message = FALSE, warning = FALSE, error = FALSE, results = "hide", fig.align="left")
...
depo <- depo %>% 
  mutate(DatumUhrzeit = as.POSIXct(DatumUhrzeit, format = "%m.%d.%Y. %H:%M")) %>% 
