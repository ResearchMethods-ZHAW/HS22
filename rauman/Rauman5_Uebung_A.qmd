...
#|   Die Vektordaten sind alle als Layers im File [windkraft_geodata.gpkg](https://moodle.zhaw.ch/mod/resource/view.php?id=663498)
#|   abgespeichert. Die Rasterdaten stehen als Geotiff zur Verfügung ([dhm250m.tif](https://moodle.zhaw.ch/mod/resource/view.php?id=694260) und [wind250m.tif](https://moodle.zhaw.ch/mod/resource/view.php?id=602297))
#| label: tbl-mce-data
library(sf)
library(dplyr) 
library(purrr)
...
In diesem ersten Teil (Übung A) widmen wir uns, basierend auf @gilgen2010 und @tegou210, folgender Paramter: 
