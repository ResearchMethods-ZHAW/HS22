...
In der folgenden Übung möchten wir potentielle Standorte für Windkraftanlagen im Kanton Schwyz ermitteln. Zu diesem Zweck führen wir eine Multikriterien-Evaluation durch. In diesem ersten Teil (Übung A) widmen wir uns, basierend auf @gilgen2010 und @tegou210, folgender Paramter: 
...
Schau dir auch das Koordinatensystem an. Was fällt dir auf? Wir würden gerne mit dem neuen schweizer Koordinatensystem arbeiten. Um ein Koordinatensystem umzuwandeln kannst du die Funktion `st_transform()` benutzen. 
