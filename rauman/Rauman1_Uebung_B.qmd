...
```{r}
#| include: false
st_layers(here("data", "gruental.gpkg"))

wiesen <- read_sf(here("data","gruental.gpkg"), "wiesen")
baeume <- read_sf(here("data","gruental.gpkg"), "baeume")
```
...
```{r}
#| fig.cap: Beispielsweise kannst du die Daten in dieser Weise visualisieren.
ggplot(wiesen) +
