...
::: {.column-body}
```{r, echo=FALSE, message=FALSE, warning=FALSE, error=FALSE, fig.cap="Stickstoffdioxid (NO2) in μg/m3, Interpoliert über die ganze Schweiz mit der Inverse Distance Weighted Methode. Die verschiedenen Plots zeigen die Veränderung der Interpolation bei steigendem IDP-Wert"}
library(purrr)
library(tidyr)
...
ggsave(here("rauman/images","idw.png"), height = 18, width = 20, units = "cm")
