...
Welche dieser Zwischenresultate sind Einzelwerte und welche Vektoren? 

Nun quadrieren wir die Differenzen:
...
Für Fortgeschrittene: Erstellt aus dem erarbeiten Workflow eine *function* um Morans I auf der Basis von einem `sf` Objekt sowie einer Spalte dessen zu berechnen. 
...
p1 <- p + labs(title = paste("Kantone: Global Morans I:",round(MI,2)))
