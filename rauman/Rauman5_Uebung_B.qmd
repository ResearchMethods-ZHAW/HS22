...
Zur Bewertung der Standorte hinsichtlich Windgeschwindigkeit steht uns folgender *wind250m.tif* zur Verfügung (siehe @tbl-mce-data). Lade den Datensatz herunter und mit der Funktion `rast()` in R ein. Explorieren Sie den Datensatz visuell und versuchen Sie ein Verständnis für die Datensätze zu bekommen. 
