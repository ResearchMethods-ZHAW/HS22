...
|:---|:---|:---|:---|:---|
| [dhm25m.tif](https://moodle.zhaw.ch/mod/resource/view.php?id=602285) | CH1903/LV03 | Geländemodell (m) | Raster (25m) | Nein |
| [eis25m.tif](https://moodle.zhaw.ch/mod/resource/view.php?id=602288) | CH1903/LV03 | Häufigkeit der Vereisung (Tage/Jahr) | Raster (25m) | Nein |
| [wind25m.tif](https://moodle.zhaw.ch/mod/resource/view.php?id=602297) | CH1903/LV03 | Durchschnittliche Windgeschwindigkeit (dm/s) | Raster (25m) | Nein |
...
#Raster data
eis25m <- rast("datasets/rauman/eis25m.tif")
dhm25m <- rast("datasets/rauman/dhm25m.tif")
wind25m <- rast("datasets/rauman/wind25m.tif")
```

```{r}
#| include: false
#| label: fig-solutionEx2
