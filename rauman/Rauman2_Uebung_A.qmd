...
Als erstes wollen wir für die Datensätze `luftqualitaet.gpkg` und `rotmilan.gpkg` Dichteschätzungen durchführen. Ladet dafür die notwendigen Package und ladet bei Bedarf die Datensätze herunter.
