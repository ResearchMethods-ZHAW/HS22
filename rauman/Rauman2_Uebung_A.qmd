...
- [schweiz.gpkg](https://moodle.zhaw.ch/mod/resource/view.php?id=602281): Landesgrenze der Schweiz

Als erstes wollen wir für die Datensätze `luftqualitaet` und `rotmilan` Dichteschätzungen durchführen. Lade diese Datensätze herunter und in R ein. Lade vorgängig die dafür die notwendigen Packages in deine R-Session.
...
library(spatstat.geom)    # <- ggf. installieren!
library(spatstat.explore) # <- ggf. installieren!
```
