...
knitr::purl("stat5-8/Statistik8_Loesung.qmd", "purl/Statistik8_Loesung.R", documentation = 0)
```
...
```{r}
#| label: fig-baseplot-agglomerative-clusteranalysis
#| fig-cap: "Generierter Plot"
...
```{r}
#| label: fig-baseplot-agglomerative-clusteranalysis-compare
#| fig-cap: "Generierter Plot"
