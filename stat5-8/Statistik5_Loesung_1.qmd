...
knitr::purl("stat5-8/Statistik5_Loesung_1.qmd", "purl/Statistik5_Loesung_1.R", documentation = 0)
```
...
- [R-Skript als Download](../purl/Statistik5_Loesung_1.R)
- [Lösungstext](Statistik_Loesung_5.1.pdf)
...
```{r}
#| label: fig-baseplot-glmm-expl-log10
#| fig-cap: "Generierter Plot"
...
```{r}
#| label: fig-baseplot-glmm-result
#| fig-cap: "Generierter Plot"
