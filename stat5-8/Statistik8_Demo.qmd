...
knitr::purl("stat5-8/Statistik8_Demo.qmd", "purl/Statistik8_Demo.R", documentation = 0)
```

# Cluster-Analysen

- [Demoscript als Download](../purl/Statistik8_Demo.R)
...
```{r}
#| label: fig-baseplot-agglomerative-clustering
#| fig-cap: "Generierter Plot"
...
```{r}
#| label: fig-baseplot-cophenetic-correlations
#| fig-cap: "Generierter Plot"
...
```{r}
#| label: fig-baseplot-dendrogram-final
#| fig-cap: "Generierter Plot"
...
```{r}
#| label: fig-baseplot-dendrogram-heatmap
#| fig-cap: "Generierter Plot"
