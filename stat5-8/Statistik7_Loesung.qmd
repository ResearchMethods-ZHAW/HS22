...
knitr::purl("stat5-8/Statistik7_Loesung.qmd", "purl/Statistik7_Loesung.R", documentation = 0)
```

## Musterlösung Aufgabe 7.1: RDA

- [R-Skript als Download](../purl/Statistik7_Loesung.R)
- [Lösungstext](Statistik_Loesungstext_7.1.pdf)
