...
knitr::purl("stat5-8/Statistik6_Loesung.qmd", "purl/Statistik6_Loesung.R", documentation = 0)
```

- Datensatz: [Doubs.RData](https://moodle.zhaw.ch/mod/resource/view.php?id=606667)
- [R-Skript als Download](../purl/Statistik6_Loesung.R)
- [Lösungstext](Statistik_Loesungstext_6.1.pdf)
