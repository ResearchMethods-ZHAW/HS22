...
knitr::purl("stat5-8/Statistik5_Demo.qmd", "purl/Statistik5_Demo.R", documentation = 0)
```

# Von linearen Modellen zu GLMMs
- [Demoscript als Download](../purl/Statistik5_Demo.R)
...
```{r}
#| label: fig-interaction-plot-anova
