...
Erstellen von Density Plots der Präsenz / Absenz in Abhängigkeit der unabhängigen Variablen
...
for (i in 6:12) {          # innerhalb des for()-loops die Nummern der gewünschten 
                           # Spalten einstellen
  d  <-  DF_mod_day %>% pull(i)
  d  <-  density(d)
