...
```{r tidy= TRUE, results='hide', warning=FALSE, message=FALSE, eval=FALSE}
...
```{r tidy=TRUE, fig.keep="none", warning=FALSE, message=FALSE, results='hide', eval=FALSE}
...
ggplot(DF_mod_day, äs(nmb)) + geom_histogram()
```
...
```{r tidy=TRUE, fig.width=5, fig.height=3 , warning=FALSE, message=FALSE, eval=FALSE}
