...
df_team1 <- read_delim("fallstudie_n/data/Felderhebung_Waldstruktur.csv", 
                       delim = ";")

df_team2 <- read_delim("fallstudie_n/data/Felderhebung_Team_2.csv", delim = ";")
...
df_team5 <- read_delim("fallstudie_n/data/Felderhebung_Waldstruktur_Team5.csv", 
                       delim = ";")
# Achtung! Beim Umwandeln in das CSV muss hier die Titelzeile entfernt werden damit
# das Einlesen reibungslos funktioniert

df_team6 <- read_delim("fallstudie_n/data/Team6_Felderhebung.csv", 
                       delim = ";")
