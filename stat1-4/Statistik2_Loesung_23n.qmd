...
knitr::purl("stat1-4/Statistik2_Loesung_23n.qmd", "purl/Statistik2_Loesung_23n.R", documentation = 0)
```

- Datensatz [kormoran.csv](https://moodle.zhaw.ch/mod/resource/view.php?id=604484)
- [RCode als Download](../purl/Statistik2_Loesung_23n.R)
- [Lösungstext 2.3](Statistik_Loesung_2.3N.pdf)
...
```{r}
#| label: fig-boxplot-sol3-expl-log10
#| fig-cap: "Generierter Plot"
...
```{r}
#| label: fig-boxplot-sol3-expl-comb
#| fig-cap: "Generierter Plot"
...
```{r}
#| label: fig-baseplot-sol3-aov-log10
#| fig-cap: "Generierter Plot"
