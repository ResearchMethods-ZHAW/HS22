...
knitr::purl("stat1-4/Statistik4_Loesung_1.qmd", "purl/Statistik4_Loesung_1.R", documentation = 0)
```
...
- [R-Code als Download](../purl/Statistik4_Loesung_1.R)
- [Lösungstext Beispiel](Statistik_Loesung_4.1.pdf)
...
```{r}
#| label: fig-boxplot-sol1-modeldiagnostics
#| fig-cap: "Generierter Plot"
...
```{r}
#| label: fig-baseplot-sol1-final-log
#| fig-cap: "Generierter Plot"
