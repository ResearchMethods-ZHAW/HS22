...
knitr::purl("stat1-4/Statistik4_Loesung_2s.qmd", "purl/Statistik4_Loesung_2s.R", documentation = 0)
```

- Datensatz [2019_ZHAW_vonRickenbach_cleaned_recorded_survey_dataset_NOVANIMAL_anonym.csv](https://zenodo.org/record/3554884/files/2020_ZHAW_vonRickenbach_Variablen_cleaned_recoded_survey_dataset_anonym_NOVANIMAL.pdf?download=1)
- Download [R-Skript](../purl/Statistik4_Loesung_2s.R) 
