...
knitr::purl("stat1-4/Statistik4_Demo.qmd", "purl/Statistik4_Demo.R", documentation = 0)
```

- [Demoscript als Download](../purl/Statistik4_Demo.R)
- Datensatz [loyn.csv](https://moodle.zhaw.ch/mod/resource/view.php?id=604496)

## von LMs zu GLMs

```{r}
#| label: fig-baseplots-lmglm
...
```{r}
#| label: fig-baseplots-nlr-glm-smoother
#| fig-cap: "Generierter Plot"
