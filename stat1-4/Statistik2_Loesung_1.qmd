...
knitr::purl("stat1-4/Statistik2_Loesung_1.qmd", "purl/Statistik2_Loesung_1.R", documentation = 0)
```

- Datensatz [SAR.csv](https://moodle.zhaw.ch/mod/resource/view.php?id=604474)
...
### Modelldiagnostik
```{r}
#| label: fig-plot-modeldiagnostics
#| fig-cap: "Generierter Plot"
...
### Modelldiagnostik
```{r}
#| label: fig-plot-solA-modeldiagnostics
#| fig-cap: "Generierter Plot"
...
### Modelldiagnostik
```{r}
#| label: fig-plot-solB-modeldiagnostics
#| fig-cap: "Generierter Plot"
