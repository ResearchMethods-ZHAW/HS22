...
knitr::purl("stat1-4/Statistik2_Loesung_Beispiel.qmd", "purl/Statistik2_Loesung_Beispiel.R", documentation = 0)
```

## Musterlösung Beispiel
- Datensatz [decay.csv](https://moodle.zhaw.ch/mod/resource/view.php?id=606697)
- [RCode als Download](../purl/Statistik2_Loesung_Beispiel.R)
- [Lösungstext Beispiel](Statistik_Loesung_Beispiel.pdf)

### Übungsaufgabe 
_**(hier so ausführlich formuliert, wie dies auch in der Klausur der Fall sein wird)**_
...
```{r}
#| label: fig-boxplot-modeldiagnostics
#| fig-cap: "Generierter Plot"
...
```{r}
#| label: fig-boxplot-var1-modeldiagnostics
#| fig-cap: "Generierter Plot"
...
_**könnte für die Datenverteilung passen, entspricht aber nicht der physikalischen**_
...
```{r}
#| label: fig-boxplot-var2-modeldiagnostics
#| fig-cap: "Generierter Plot"
...
```{r}
#| label: fig-boxplot-var3-modeldiagnostics
#| fig-cap: "Generierter Plot"
...
```{r}
#| label: fig-boxplot-var3-result-log
#| fig-cap: "Generierter Plot"
...
```{r}
#| label: fig-boxplot-var3-result-quadm
#| fig-cap: "Generierter Plot"
...
```{r}
#| label: fig-boxplot-var3-result-nlm
#| fig-cap: "Generierter Plot"
