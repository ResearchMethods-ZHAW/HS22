...
knitr::purl("stat1-4/Statistik2_Loesung_Beispiel.qmd", "stat1-4/Statistik2_Loesung_Beispiel.R", documentation = 0)
```

## Musterlösung Beispiel
- Datensatz [decay.csv](https://github.com/ResearchMethods-ZHAW/datasets/raw/main/statistik/decay.csv)
- [RCode als Download](Statistik2_Loesung_Beispiel.R)
