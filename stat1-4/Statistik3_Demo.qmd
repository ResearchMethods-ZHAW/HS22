...
knitr::purl("stat1-4/Statistik3_Demo.qmd", "purl/Statistik3_Demo.R", documentation = 0)
```
...
```{r}
#| label: fig-hierarchical-partitioning
...
### Partial regressions
```{r}
#| label: fig-plots-lm-partial-reg
#| fig.cap: ""
