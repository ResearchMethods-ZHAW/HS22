---
title: "Statistik 3 - Lösung"
author: ???
image: distill-preview.png
categories: Statistik3
draft: false
---

```{r, echo = FALSE, message=FALSE, results = "hide", purl = FALSE}
knitr::purl("Statistik3_Loesung.qmd", "Statistik3_Loesung.R", documentation = 0)
```

- Download [R-Skript](Statistik3_Loesung.R)
