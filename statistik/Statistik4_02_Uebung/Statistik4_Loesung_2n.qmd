---
title: "Statistik 4 - Übung 2N - Lösung"
author: ???
image: distill-preview-2n.png
categories: Statistik4
draft: false
---

```{r, echo = FALSE, message=FALSE, results = "hide", purl = FALSE}
knitr::purl("Statistik4_Loesung_2n.qmd", "Statistik4_Loesung_2n.R", documentation = 0)
```

## Musterlösung Aufgabe 4.2N: Multiple logistische Regression

- [R-Skript als Download](Statistik4_Loesung_2n.R)
