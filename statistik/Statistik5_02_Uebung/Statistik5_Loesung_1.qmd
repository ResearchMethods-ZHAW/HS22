---
title: "Statistik 5 - Übung 1 - Lösung"
author: ???
image: distill-preview-1.png
categories: Statistik5
draft: false
---
```{r, echo = FALSE, message=FALSE, results = "hide", purl = FALSE}
knitr::purl("Statistik5_Loesung_1.qmd", "Statistik5_Loesung_1.R", documentation = 0)
```
...
- [R-Skript als Download](Statistik5_Loesung_1.R)
