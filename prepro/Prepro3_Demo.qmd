...
Diese Demo kann auch als [R Script heruntergeladen werden](Prepro3_Demo.R) (Rechtsklick → *Save Target As..*)
...
```{r}
#| label: fig-ggplot-long
#| fig-cap: "Generiereter Plot"
...
#knitr::purl("prepro/Prepro3_Demo.qmd", "prepro/Prepro3_Demo.R",documentation = 0)
```
