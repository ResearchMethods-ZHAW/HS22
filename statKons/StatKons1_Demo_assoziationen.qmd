...
knitr::purl("statKons/StatKons1_Demo_assoziationen.qmd", "purl/StatKons1_Demo_assoziationen.R", documentation = 0)
```
...
```{r}
#| eval: true
#| label: fig-baseplot-mosaic-plots-mtcars-example
...
```{r}
#| eval: true
#| label: fig-ggplot-mtcars-example
#| fig-cap: "Generierter Plot"
