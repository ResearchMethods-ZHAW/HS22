...
> Download [R-Skript](../purl/StatKons2_Demo_PCA.R)

## PCA mit sveg
```{r}
#| label: fig-baseplot-pca-sveg
...
```{r}
#| label: fig-baseplot-pca-example
#| fig-cap: "Generierter Plot"
...
```{r}
#| eval: false
#| label: fig-baseplot-nmds-example
#| fig-cap: "Generierter Plot"
...
## NMDS mit mtcars
```{r}
#| label: fig-baseplot-nmds-mtcars-example
#| fig-cap: "Generierter Plot"
