...
knitr::purl("statKons/StatKons3_Demo_LM.qmd", "purl/StatKons3_Demo_LM.R", documentation = 0)
```
...
```{r}
#| echo: false
#| label: fig-plots-multi-anova-example
#| fig-cap: "Generierter Plot"
...
## Einfache Regression
```{r}
#| label: fig-plots-regression-example
#| fig-cap: "Generierter Plot"
...
```{r}
#| label: fig-plots-multi-regression-example
#| fig-cap: "Generierter Plot"
