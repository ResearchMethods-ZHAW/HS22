...
> Download [R-Skript](../purl/StatKons4_Demo_GLM.R)
...
```{r}
#| label: fig-plots-quasipoisson-regression-example
...
```{r}
#| label: fig-plots-logistic-regression-example
#| fig-cap: "Generierter Plot"
...
```{r}
#| label: fig-plots-loess-gam-example
#| fig-cap: "Generierter Plot"
